...
public class CrackBallScr : mScreen
{
	...
	private void doClickBall(int index)
	{
		...
		{
			SoundMn.gI().getItem();
			int num = ((typePrice != 0) ? Char.myCharz().luong : Char.myCharz().xu);
	...
	public override void paint(mGraphics g)
	{
		try
		{
			...
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().xu + string.Empty, num4 + 24, num5 - 13, mFont.LEFT, mFont.tahoma_7_grey);
			mFont.tahoma_7_yellow.drawString(g, Char.myCharz().luong + string.Empty, num4 + 100, num5 - 13, mFont.LEFT, mFont.tahoma_7_grey);
			g.drawImage(Panel.imgTicket, num4 + 150, num5 - 7, 3);
			mFont.tahoma_7_yellow.drawString(g, numTicket + string.Empty, num4 + 160, num5 - 13, mFont.LEFT, mFont.tahoma_7_grey);
			if (step < 4)
			{
				int num6 = num3 / 2 + 20;
				...
				{
					g.drawImage(Panel.imgLuong, num7 + 21, num5 + 7, 3);
				}
